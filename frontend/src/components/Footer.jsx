    ...
    <>
      ...
      <footer class="bg-white dark:bg-green-950">
        <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          <div class="md:flex md:items-start md:justify-between">
            <div class="mb-6 md:mb-0">
              ...
              <div class="max-w-2xl mt-4 text-justify">
                ...
                {/* Social media icons */}
                <div class="flex justify-start space-x-10 mt-4 sm:mt-14">
                  <a
                    href="#"
            ...
            {/* Footer column-2 */}
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 ml-10">
              <div>
                <h2 class="mb-9 text-sm font-semibold text-gray-900 uppercase dark:text-white">
                  Navigation
                </h2>
              ...
              <div>
                ...
                <div className="flex mb-6 items-center text-gray-500 dark:text-gray-400 font-medium">
                  <FaPhoneAlt className="mr-2 hover:text-white" />
          ...
          {/* Social media icons
          <div class="flex justify-start space-x-10 mt-4 sm:mt-3">
            <a
              href="#"
              class="text-gray-500 hover:text-gray-900 dark:hover:text-white"
            >
          ...
          <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400 block mx-auto">
              © 2023{" "}
              <a href="https://flowbite.com/" class="hover:underline">
                GreenLands™
              </a>
