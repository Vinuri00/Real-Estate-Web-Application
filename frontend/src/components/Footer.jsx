...
const Footer = () => {
  return (
    <>
      ...
      <footer className="bg-white dark:bg-green-950">
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          <div className="md:flex md:items-start md:justify-between">
            <div className="mb-6 md:mb-0">
              <a href="https://flowbite.com/" className="flex items-center">
                <img
                  src={logo}
                  className="h-10 mr-4 w-auto me-3"
                  alt="FlowBite Logo"
                />
              ...
              <div className="max-w-2xl mt-4 text-justify">
                ...
                {/* Social media icons */}
                <div className="flex justify-start space-x-10 mt-4 sm:mt-14">
                  <a
                    href="#"
            ...
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 ml-10">
              <div>
                <h2 className="mb-9 text-sm font-semibold text-gray-900 uppercase dark:text-white">
                  Navigation
                </h2>
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400 block mx-auto">
              © 2023{" "}
              <a href="/" className="hover:underline">
                GreenLands™
              </a>
