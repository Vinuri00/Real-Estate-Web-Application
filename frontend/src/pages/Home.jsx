      ...
      <div className="container mx-auto px-10 pt-16">
        ...
        {showLawyers && (
          <div className="mb-8"> {/* Add margin-bottom for spacing */}
            <h3 className="text-xl font-semibold text-gray-800 mb-4">Lawyer Services Section</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white rounded-lg overflow-hidden shadow-md">
                ...
                />
                <div className="p-6">
                  <h3 className="text-xl font-semibold text-gray-800 mb-2">Lawyer Service</h3>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white rounded-lg overflow-hidden shadow-md">
                ...
                />
                <div className="p-6">
                  <h3 className="text-xl font-semibold text-gray-800 mb-2">Brokerage Service</h3>
                  <p className="text-gray-600">Details about brokerage service.</p>
                </div>
              </div>
