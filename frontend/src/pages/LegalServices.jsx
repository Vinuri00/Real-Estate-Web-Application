      ...
      <div className="">
        <section className="bg-center bg-cover bg-no-repeat bg-[url('assets/images/legal1.webp')] bg-gray-600 bg-blend-multiply">
          <div className="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
            ...
            <p className="mb-8 text-lg font-normal text-gray-300 lg:text-xl sm:px-16 lg:px-24">
              ...
              and relax. Say goodbye to tax-related stress and let us handle
              your legal needs. Contact us today to schedule an appointment and
        ...
        <div className="px-4 mx-auto max-w-screen-xl text-center">
          ...
          <p className="text-lg text-gray-500 dark:text-gray-500 mt-6">
            ...
            seeking convenient and efficient legal solutions. With Rocket
            Lawyer, you gain access to a wide range of legal documents and
            services that can be customized to your specific needs. Whether you
            require a simple agreement or a more complex legal document, Rocket
            Lawyer simplifies the process. With Rocket Lawyer, legal assistance
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 font-serif">
            <div className="max-w-sm p-6 bg-white border rounded-lg shadow-xl border-gray-200 relative dark:bg-white dark:border-gray mt-14 text-center hover:scale-110 transition-transform duration-500">
              ...
              <p className="mb-3 text-justify font-normal text-gray-600 dark:text-gray-500">
                Rocket Lawyer offers a user-friendly platform that allows for
                easy customization, empowering users to tailor legal documents
                and services to their specific needs with minimal effort.
              </p>
              <a
                href="#"
            ...
            <div className="max-w-sm p-6 bg-white border rounded-lg shadow-xl border-gray-200 relative dark:bg-white dark:border-gray mt-14 text-center hover:scale-110 transition-transform duration-500">
              ...
              <p className="mb-3 text-justify font-normal text-gray-600 dark:text-gray-500">
                ...
                sure that you are getting a quality document that will hold up
                in court ensuring the highest quality and legal validity. So you
