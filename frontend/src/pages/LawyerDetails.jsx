...
//   useEffect(() => {
//     fetch("http://localhost:3000/lawyers/get-all")
...
//                 Our Team
//               </h2>
//               <p className="font-light text-black-500 lg:mb-16 sm:text-xl dark:text-black-400">
...
//                 >
//                   <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-green-950 dark:border-gray-700">
//                     {lawyer.image.map((image, index) => (
//                       <a href="#" key={index}>
//                         <img
            ...
            {lawyers.map((lawyer) => (
              ...
              >
                ...
                <div className="p-5 items-center">
                  ...
                  <a
                    href="/BookingLawyer"
                    onClick={() => handleSelect(lawyer._id)}
